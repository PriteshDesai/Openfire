...
public class ClickAction {
	...
	@JsonProperty(value = "rich_resource")
	...
	public void check() {
		...
		ValidatorUtils.checkArgument(isTrue,
				"click type should be one of 1: customize action, 2: open url, 3: open app, 4: open rich media");
		...
		case 2:
			...
			break;
		case 4:
			ValidatorUtils.checkArgument(StringUtils.isNotEmpty(this.richResource),
					"richResource is required when click type=4");
