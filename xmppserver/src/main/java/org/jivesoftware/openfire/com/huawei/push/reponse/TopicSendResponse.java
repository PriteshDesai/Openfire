...
public final class TopicSendResponse extends SendResponse {
	...
	private TopicSendResponse(String code, String msg, String requestId, Integer failureCount, Integer successCount,
			JsonArray errors) {
	...
	public static TopicSendResponse fromCode(String code, String msg, String requestId, Integer failureCount,
			Integer successCount, JsonArray errors) {
