 ...
 */
public class LocalMUCRole extends MUCRole {

	Logger Log = LoggerFactory.getLogger(LocalMUCRole.class);
	...
	public void setRole(MUCRole.Role newRole) throws NotAllowedException {
		...
		// TODO A moderator MUST NOT be able to revoke voice from a user whose
		// affiliation is at or
	...
	public String toString() {
		return "LocalMUCRole{" + "room=" + room + ", user=" + user + ", nick='" + nick + '\'' + ", role=" + role
