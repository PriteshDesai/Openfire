...
@XmlRootElement(name = "updateCallConference")
public class UpdateCallConference {
	...
	public UpdateCallConference() {
	}

	public UpdateCallConference(String title, String description, String callConferenceId, String timeZone,
